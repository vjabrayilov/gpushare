...
W. Kwon \emph{et al.}, ``Efficient Memory Management for Large Language Model Serving with PagedAttention,'' in \emph{SOSP}, 2023. (Also available as arXiv:2309.06180.)

\bibitem{nvidia_mps_docs}
NVIDIA, ``CUDA Multi-Process Service (MPS) Documentation,'' \url{https://docs.nvidia.com/deploy/mps/index.html}.

\bibitem{nvidia_mig_supported_gpus}
NVIDIA, ``Multi-Instance GPU User Guide: Supported GPUs,'' \url{https://docs.nvidia.com/datacenter/tesla/mig-user-guide/supported-gpus.html}.

\bibitem{aws_g6_instances}
Amazon Web Services, ``Amazon EC2 G6 Instances,'' \url{https://aws.amazon.com/ec2/instance-types/g6/}.
